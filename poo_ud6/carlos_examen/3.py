...
for jugador_atl in atletico_madrid:
    for jugador_selec in seleccion_espanola:
        if jugador_atl.nombre == jugador_selec.nombre:
            print(jugador_atl.nombre)

print("\n-------------\n")

print("Los jugadores del Atlético de Madrid que van a la Selección Española y que son titulares en ambos equipos son:")
for jugador_atl in atletico_madrid:
    for jugador_selec in seleccion_espanola:
        if jugador_atl.nombre == jugador_selec.nombre and jugador_atl.titular == True and jugador_selec.titular == True:
            print(jugador_atl.nombre)