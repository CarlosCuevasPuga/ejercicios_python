...
def mostrar_alineacion(plantilla: list):
    ...
    for jugador in jugadores:
        if jugador.posicion == "Portero":
            print(f"Portero: ({jugador.dorsal}) {jugador.nombre}",end="  -- ")
    print()
    for jugador in jugadores:
        if jugador.posicion == "Defensa":
            print(f"Defensa: ({jugador.dorsal}) {jugador.nombre}",end="  -- ")
    print()
    for jugador in jugadores:
        if jugador.posicion == "Centrocampista":
            print(f"Centrocampistas: ({jugador.dorsal}) {jugador.nombre}",end="  -- ")
    print()
    for jugador in jugadores:
        if jugador.posicion == "Delantero":
            print(f"Delanteros: ({jugador.dorsal}) {jugador.nombre}",end="  -- ")
